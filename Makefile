...
LDFLAGS=-lelf -ldl -Wl,-rpath,. -rdynamic -lmpfr -lgmp
INCLUDES=-I .
CC=gcc
...
libunitsystem.so: unitsystem.c unitsystem.h rational.o prefix.o atom.o part.o unit.o library.o /repos/butcher/bt.h
